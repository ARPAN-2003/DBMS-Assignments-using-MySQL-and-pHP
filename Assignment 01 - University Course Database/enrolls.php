<?php
    ...
    if (!$conn) {
        ...
        $insert_query = "INSERT INTO Enrolls (CourseID, PersonID) VALUES ('$courseId', '$personId')";

        if (mysqli_query($conn, $insert_query)) {
            $success = true;
            $message = "Enrolls Form data is successfully stored in University Database. Thank You.";
        } else {
            $success = false;
            $message = "Error inserting data: " . mysqli_error($conn);
        }

        $select_query = "SELECT * FROM Enrolls ORDER BY CourseID";
...
<head>
    ...
    <title>Enrolls Form Submission Result</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        ...
        <div class="data-display-section">
            <h3>📊 Inserted Data - Enrolls Table</h3>
        ...
        <div class="button-group">
            ...
            <button class="btn-back" onclick="window.location.href='enrolls.html'">↻ &nbsp; Insert another data</button>
        </div>
    </div>
</body>
</html>