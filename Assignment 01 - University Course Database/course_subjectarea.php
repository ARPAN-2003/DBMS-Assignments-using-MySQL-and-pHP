<?php
    ...
    if (!$conn) {
        ...
        $insert_query = "INSERT INTO Course_SubjectArea (CourseID, AreaID) VALUES ('$courseId', '$subjectId')";

        if (mysqli_query($conn, $insert_query)) {
            $success = true;
            $message = "Course-Subject Area Form data is successfully stored in Course_SubjectArea Database. Thank You.";
        } else {
            $success = false;
            $message = "Error inserting data: " . mysqli_error($conn);
        }

        $select_query = "SELECT * FROM Course_SubjectArea ORDER BY CourseID";
...
<head>
    ...
    <title>Course-Subject Area Form Submission Result</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        ...
        <div class="data-display-section">
            <h3>📊 Inserted Data - Course_SubjectArea Table</h3>
        ...
        <div class="button-group">
            ...
            <button class="btn-back" onclick="window.location.href='course_subjectarea.html'">↻ &nbsp; Insert another data</button>
        </div>
    </div>
</body>
</html>