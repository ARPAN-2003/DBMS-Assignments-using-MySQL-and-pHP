<?php
    ...
    if (!$conn) {
        ...
        $insert_query = "INSERT INTO Course_Instructor (CourseID, InstructorID) VALUES ('$courseId', '$instructorId')";

        if (mysqli_query($conn, $insert_query)) {
            $success = true;
            $message = "Course-Instructor Form data is successfully stored in Course_Instructor Database. Thank You.";
        } else {
            $success = false;
            $message = "Error inserting data: " . mysqli_error($conn);
        }

        $select_query = "SELECT * FROM Course_Instructor ORDER BY CourseID";
...
<head>
    ...
    <title>Course-Instructor Form Submission Result</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        ...
        <div class="data-display-section">
            <h3>📊 Inserted Data - Course-Instructor Table</h3>
        ...
        <div class="button-group">
            ...
            <button class="btn-back" onclick="window.location.href='course_instructor.html'">↻ &nbsp; Insert another data</button>
        </div>
    </div>
</body>
</html>