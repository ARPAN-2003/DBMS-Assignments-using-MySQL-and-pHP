<?php
    ...
    if (!$conn) {
        ...
        $projectName = isset($_POST['projectName']) ? mysqli_real_escape_string($conn, $_POST['projectName']) : '';
        ...
        $insert_query = "INSERT INTO Final_Project (ProjectID, ProjectName, CourseID, StudentID) VALUES ('$projectId', '$projectName', '$courseId', '$studentId')";

        if (mysqli_query($conn, $insert_query)) {
            $success = true;
            $message = "Final Project Form data is successfully stored in Final_Project Database. Thank You.";
        } else {
            $success = false;
            $message = "Error inserting data: " . mysqli_error($conn);
        }

        $select_query = "SELECT * FROM Final_Project ORDER BY ProjectID";
...
<head>
    ...
    <title>Final Project Form Submission Result</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        ...
        <div class="data-display-section">
            <h3>📊 Inserted Data - Final_Project Table</h3>
        ...
        <div class="button-group">
            ...
            <button class="btn-back" onclick="window.location.href='final_project.html'">↻ &nbsp; Insert another data</button>
        </div>
    </div>
</body>
</html>