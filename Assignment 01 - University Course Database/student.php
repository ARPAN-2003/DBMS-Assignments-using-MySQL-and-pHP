<?php
    ...
    if (!$conn) {
        ...
        $insert_query = "INSERT INTO Student (StudentID, PersonID) VALUES ('$studentId', '$personId')";

        if (mysqli_query($conn, $insert_query)) {
            $success = true;
            $message = "Student Form data is successfully stored in Student Database. Thank You.";
        } else {
            $success = false;
            $message = "Error inserting data: " . mysqli_error($conn);
        }

        $select_query = "SELECT * FROM Student ORDER BY StudentID";
...
<head>
    ...
    <title>Student Form Submission Result</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        ...
        <div class="data-display-section">
            <h3>📊 Inserted Data - Student Table</h3>
        ...
        <div class="button-group">
            ...
            <button class="btn-back" onclick="window.location.href='student.html'">↻ &nbsp; Insert another data</button>
        </div>
    </div>
</body>
</html>