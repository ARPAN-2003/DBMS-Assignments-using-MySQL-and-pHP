<?php
    ...
    if (!$conn) {
        ...
        $insert_query = "INSERT INTO Writes (EmployeeID, PaperID) VALUES ('$empId', '$paperId')";

        if (mysqli_query($conn, $insert_query)) {
            $success = true;
            $message = "Researcher_writes_ResearchPaper Form data is successfully stored in Research Database. Thank You.";
        } else {
            $success = false;
            $message = "Error inserting data: " . mysqli_error($conn);
        }

        $select_query = "SELECT * FROM Writes ORDER BY EmployeeID";
...
<head>
    ...
    <title>Researcher_writes_ResearchPaper Form Submission Result</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        ...
        <div class="data-display-section">
            <h3>📊 Inserted Data - Writes Table</h3>
        ...
        <div class="button-group">
            ...
            <button class="btn-back" onclick="window.location.href='researcher_writes_researchpaper.html'">↻ &nbsp; Insert another data</button>
        </div>
    </div>
</body>
</html>